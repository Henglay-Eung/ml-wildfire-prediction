...
df = pd.read_csv('./fips_tp_data.csv')
initial_rows = len(df)
...
filtered_df.to_csv('fips_tp_no_na_averaged.csv', index=False)
logging.info("Filtered data saved to 'fips_tp_no_na_averaged.csv'")
